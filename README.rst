...
This repository contains my personal recipes.

See `RECIPES.md`_ for a full list of recipes that live in this repository.

Configuring the endpoint in your project
----------------------------------------
...
.. code-block:: json

    {
        "extra": {
            "symfony": {
                "endpoint": [
                    "https://api.github.com/repos/NimZero/FlexRecipes/contents/index.json?ref=flex/main",
                    "flex://defaults"
                ]
            }
        }
...
.. _`RECIPES.md`: https://github.com/NimZero/FlexRecipes/blob/flex-main/RECIPES.md
